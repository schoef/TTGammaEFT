...
dirs['TTZ']              = ["TTZ_LO"]
dirs['TTH']              = ["TTHnobb_pow", "TTHbb_pow"]
...
TT_pow_16          = Sample.fromDirectory(name="TT_pow",           treeName="Events", isData=False, color=color.TTJets,          texName="t#bar{t}",          directory=directories['TT_pow'])
...
#TG_16              = Sample.fromDirectory(name="TG",               treeName="Events", isData=False, color=color.TG,              texName="t#gamma",           directory=directories['TG'])
#WG_16              = Sample.fromDirectory(name="WG",               treeName="Events", isData=False, color=color.WG,              texName="W#gamma",           directory=directories['WG'])
...
ZG_16              = Sample.fromDirectory(name="ZG",               treeName="Events", isData=False, color=color.diBoson,         texName="Z#gamma",           directory=directories['ZGTo2LG'] )
#ZG_16              = Sample.fromDirectory(name="ZG",              treeName="Events", isData=False, color=color.diBoson,         texName="Z#gamma",           directory=directories['ZGToLLG'] )
